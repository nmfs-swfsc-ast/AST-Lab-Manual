...
\chapter*{How do we use sound to count
fish?}\label{how-do-we-use-sound-to-count-fish}
\addcontentsline{toc}{chapter}{How do we use sound to count fish?}

\markboth{How do we use sound to count fish?}{How do we use sound to
count fish?}

{[}add report run date{]}

\textbf{Document Objective:} This resource will serve as a tutorial to
demonstrate how the SWFSC uses acoustic data generate biomass estimates
of Coastal Pelagic Species from Baja, Mexico to Vancouver, Canada.
...
\section*{Short and sweet overview of
survey}\label{short-and-sweet-overview-of-survey}
\addcontentsline{toc}{section}{Short and sweet overview of survey}

\markright{Short and sweet overview of survey}

The SWFSC's ATM surveys of CPS in the CCE began in 2006 with a focus on
the northern stock of Pacific Sardine. Since then, we have expanded in
scope and objectives to include the larger forage-fish assemblage and
...
\section*{\texorpdfstring{\textbf{NOAA
README}}{NOAA README}}\label{noaa-readme}
\addcontentsline{toc}{section}{\textbf{NOAA README}}

\markright{\textbf{NOAA README}}
...
\section*{\texorpdfstring{\textbf{NOAA
License}}{NOAA License}}\label{noaa-license}
\addcontentsline{toc}{section}{\textbf{NOAA License}}

\markright{\textbf{NOAA License}}
